es: gud is not so clean itself, there is little common
...
interpreted specially if present.  These are:
  %mmodule name of current module.
  %ddirectory of current source file.
  %cnumber of current character position
  %etext of the OCaml variable surrounding point.
